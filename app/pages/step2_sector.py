...
#            # Header
#            rx.vstack(
#                rx.text("Sélection du Secteur", font_size=Typography.SIZE_2XL, font_weight=Typography.WEIGHT_BOLD),
#                rx.text("Étape 2 sur 6 : Choisissez votre secteur d'activité", color=Colors.GRAY_500),
#                spacing="1",
#                align="center",
#            ),
#            
...
#                rx.vstack(
#                    rx.hstack(
#                        rx.icon("building-2", size=16, color=Colors.PRIMARY),
#                        rx.text("Choisissez un secteur", font_weight=Typography.WEIGHT_MEDIUM),
#                        spacing="2",
#                    ),
#                    rx.box(
#                        rx.hstack(
#                            rx.foreach(SECTORS, sector_card),
#                            spacing="3",
#                            wrap="wrap",
#                            justify="center",
#                            width="100%",
...
#                        ),
#                        rx.vstack(
#                            rx.text("Secteur sélectionné", font_size=Typography.SIZE_XS, color=Colors.GRAY_500),
...
#                    disabled=SimulationState.sector == "",
