...
def save_button() -> rx.Component:
    ...
    return rx.cond(
        ...
        rx.button(
            rx.hstack(rx.icon("check", size=18), rx.text("Sauvegardée"), spacing="2", align="center"),
            disabled=True,
            size="3",
            style={
        ...
        rx.button(
            rx.hstack(rx.icon("save", size=18), rx.text("Sauvegarder"), spacing="2", align="center"),
...
def export_button() -> rx.Component:
    """Bouton d'export PDF."""
    return rx.button(
        rx.hstack(rx.icon("download", size=18), rx.text("Exporter PDF"), spacing="2", align="center"),
