"""
Register Page
User registration page with full form validation
"""
    ...
    return rx.box(
        rx.vstack(
            ...
            rx.vstack(
                ...
                rx.text(
                    "Inscrivez-vous gratuitement pour commencer vos simulations.",
                    font_size="0.95rem",
                ...
                rx.vstack(
                    ...
                    rx.box(
                        rx.hstack(
                            ...
                            rx.text("*", color=Colors.ERROR, font_size="0.875rem"),
                            spacing="1",
                            margin_bottom="0.5rem",
                        ),
                        rx.input(
...
@rx.page(route="/register", title="Inscription - SimuPrime")
